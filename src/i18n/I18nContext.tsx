...
const en = {
  ...
  'download.note': 'Server packages are currently available for Windows x64.',
...
const ptBR: Record<TranslationKey, string> = {
  ...
  'download.note': 'Os pacotes do Servidor estão disponíveis atualmente para Windows x64.',
...
const es: Record<TranslationKey, string> = {
  ...
  'download.sdk': 'SDK nativo',
  'download.server': 'Servidor',
  'download.note': 'Los paquetes del Servidor están disponibles actualmente para Windows x64.',
